        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <div className="flex items-center gap-2 text-foreground/70">
              ...
              <a href="https://wa.me/256787308564" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                WhatsApp: +256 787 308 564
              </a>
            </div>
          </div>
